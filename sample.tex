...
Этот крейт содержит все необходимые компоненты для создания приложения no\_std (бинарный крейт), предназначенного для микроконтроллера \textbf{Mik32 Amur}. 
...
HAL предоставляет высокоуровневую аппаратную абстракцию, опираясь на трейты \textbf{embedded‑hal} и следуя канонам разработки Rust HAL.
...
\cvtag{Embedded Systems} \cvtag{Rust} \cvtag{Bare-metal} \cvtag{STM32(F4/F7 серии)}


\divider
\cvevent{ Имел опыт работы}{}{}{}
\begin{itemize}
    \item \cvtag{C/C++} - \cvtag{STM32 Hal} \cvtag{ESP-IDF} \cvtag{mongoose lib}
    \item \cvtag{Debugging} - \cvtag{JTAG/SWD} \cvtag{GDB} \cvtag{OpenOCD}
    \item \cvtag{Protocols} - \cvtag{DSHOT} \cvtag{SBUS} \cvtag{MAVLink} \cvtag{UART/SPI/I2C}
\end{itemize}
