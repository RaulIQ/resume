...
\begin{itemize}
  \item Реализовал ППРЧ на Wi-Fi адаптерах.
  \item Разработал UDP-управление дроном (Raspberry Pi <-> ПК) с режимами SBUS и MAVLink.
  \item Реализовал Bidirectional DSHOT для считывания оборотов моторов.
...
\begin{itemize}
  \item Реализовал протокол DSHOT для управления моторами.
  ...
  \item Реализовал запись телеметрии ("черный ящик") на внешнюю SPI-флеш с буферизацией.
...
Четвёртый курс направления: "Информатика и вычислительная техника"
...
\begin{itemize}
    \item Участвавал в студкемпе "Алиса и Умные устройства Яндекса"
